...
export const gridOrderImage = (props) => (
  <div>
    <img
      className="md:ml-3 rounded-xl h-20"
...
export const gridOrderStatus = (props) => (
  <button
    ...
    className="px-2 py-1 rounded-2xl text-md text-white capitalize"
  >
    {props.Status}
  </button>
);
...
const customerGridStatus = (props) => (
  <div className="flex justify-center items-center gap-2 text-gray-700 capitalize">
    <p
      style={{ background: props.StatusBg }}
